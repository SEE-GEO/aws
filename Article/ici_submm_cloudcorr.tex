...
used cloud filtering methods for these applications are based on 183\,GHz data alone, involving rules on the brightness temperatures differences between channels \citep{burns1997effects, buehler:aclou:07}.
...
\begin{figure}[t]
	...
	\caption{The distribution of point estimate (``Predicted'') obtained from QRNN-single 89+150\,GHz for MWHS-2 channel 14. The corresponding distributions for all-sky and clear-sky simulations are also shown.}
...
\begin{figure*}[t]
	\centering
	\includegraphics[height = 55mm]{Figures/fig04.pdf} 
