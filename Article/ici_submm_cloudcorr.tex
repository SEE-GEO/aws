...
\authorcontribution{The study was conceptualised and supervised by PE. The analysis, validation and visualisation of results was done IK. The QRNN package is made available by SP. IK wrote the original draft, with contributions from PE, SP and DID. DID also provided the data for MWHS-2. All authors contributed to the study with discussions and feedback.}  
