...
\begin{table}[t]
	...
	\belowtable{} % Table Footnotes
\end{table}
The Small Microwave Satellite (SMS) is a hypothetical satellite which we consider to represent the type of sensors currently being considered for future missions. We assume it to be a single across-track scanning microwave radiometer with five 183\,GHz channels and four 325\,GHz channels. A brief summary of the  channel specifications assumed is provided in Table~\ref{tab:specifications_SMS}.
