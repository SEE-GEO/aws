...
\begin{figure}[!ht]
	\centering
	\includegraphics[height=85mm]{prediction_uncertainty.png}
	\caption{The prediction uncertainty with respect to quantiles for randomly selected 2400 cases.}
