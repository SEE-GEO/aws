...
%
Using the simulation setup described above, around 77000 cases [* Is this the
correct final number? *] were simulated
...
%
[* Describe here briefly the final set of simulations used below. Number of
cases, with and without thinng. Latiude range. If the full dataset was used for
ATMS comparsion, switch place between 3.3 and 3.4. Probably easiest to say that
all results below are for nadir. Otherwise this has to be clarified for the
simple scehem. *]
