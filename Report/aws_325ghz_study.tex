...
\begin{table}[!bt]
	...
	\begin{tabular}[b]{c|c|c|c}
		...
		sreerekha& -0.181& 0.731& -0.506\\
		\hline
	\end{tabular}
	\caption{Various metrics for different subsets of the measurement dataset. The different datasets are: noise(simulation dataset),  All (all measurements are considered), thinned (50\% of clear sky measurements are removed), $1\sigma$ (cloudy measurements are filtered with noise-index = 1$\sigma$), $2\sigma$ (cloudy measurements are filtered with noise-index = 2$\sigma$), sreerekha (measurements are filtered according to criteria described in \cite{rekha2012potential})   }
