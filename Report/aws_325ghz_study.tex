...
extension, only the edge channels were changed. That is, the revised AWS-41 and AWS-43
...
revised, but this is out of the scope of this study and anyhow hardly motivated
...
of freedom (DoF) was assessed. The later analysis gave a bit clearer
...
IF of AWS-42. The later aspect also makes it hard to extend options three-b and c if
...
breakthrough requirements. Option 3c came out best here, but no full
...
better known (IF range available, needed frequent gaps between channels etc.), an
iteration of DoF analysis should be made to see if some ``optimisation'' of the
channel specifications can be achieved.
