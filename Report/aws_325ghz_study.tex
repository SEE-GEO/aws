...
Sounder (MWS) and will be used for cloud filtering of 183\,GHz insde that
...
On basis of the weighting functions of 183\,GHz, three specfications for
...
utilize the ``clear-sky'' data can greatly benefit from it. Also, in data
...
options is higher or equal to the 229\,Ghz one already in clear-sky
conditions, while  for cloud conditions 325\,GHz consistently gives two
additional degrees of freedom. That is, 325\,GHz clearly gives more rich
informaion in cloudy conditions than 229\,GHz. 
